...
- One, the word //'rAma'// loses the //'prAtipadika' saMj~nA//
  ...
  //pratyaya//-s. (Refer [Definition of a //prAtipadika//](#/subanta/general/praatipadika/#ha-The-Definition-of-prAtipadika))
...
the //'r'// which is an
[//avasAna//](#/subanta/general/avasana), is replaced by
//visarga (:)// --
